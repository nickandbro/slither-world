...
- `TYPE_PELLET_LOCK` is a lightweight visual hint; if a session is backpressured and lock frames are dropped, clients fall back to nearest-mouth consume inference for that pellet disappearance.
