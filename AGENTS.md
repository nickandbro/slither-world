...
- Pellets are replicated via `TYPE_PELLET_RESET` (full) plus `TYPE_PELLET_DELTA` (adds/updates/removes). Pellet entries use `u32 pellet_id` + oct normal (`i16 ox, i16 oy`) + `u8 color_index` + `u8 size`.
