...
export const TURN_SPEED_BOOST_TURN_PENALTY = 0.72
export const TURN_SPEED_MIN_MULTIPLIER = 0.2
export const TURN_BOOST_TURN_RATE_MULTIPLIER = 2.8
export const TURN_RESPONSE_GAIN_NORMAL_PER_SEC = 7.6
export const TURN_RESPONSE_GAIN_BOOST_PER_SEC = 4.6
export const TURN_RATE_MIN_MULTIPLIER = 0.22
export const TURN_RATE_MAX_MULTIPLIER = 4
export const TURN_SUBSTEPS_NORMAL = 2
export const TURN_SUBSTEPS_BOOST = 4
