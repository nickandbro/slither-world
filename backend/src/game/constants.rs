...
pub const SMALL_PELLET_SIZE_MIN: f32 = 0.6;
pub const SMALL_PELLET_SIZE_MAX: f32 = 1.15;
pub const SMALL_PELLET_SHRINK_MIN_RATIO: f32 = 0.24;
pub const SMALL_PELLET_ATTRACT_RADIUS: f64 = 0.22;
pub const SMALL_PELLET_LOCK_CONE_ANGLE: f64 = std::f64::consts::PI * 0.45;
pub const SMALL_PELLET_CONSUME_ANGLE: f64 = 0.014;
pub const SMALL_PELLET_ATTRACT_SPEED: f64 = 3.2;
pub const SMALL_PELLET_MOUTH_FORWARD: f64 = 0.06;
